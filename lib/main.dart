...
import 'package:designthinking/image_cropper.dart';

// Firebase Storage
import 'package:firebase_storage/firebase_storage.dart';

// Related Pages
import 'package:designthinking/home1.dart';
import 'package:designthinking/home.dart';
...
Future<void> main() async {
  ...
  runApp(
    MaterialApp(
      routes: {'/': (BuildContext context) => HomePage(camera: firstCamera)},
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          try {
            ...
            final File image = await _cropImage(File(path));
